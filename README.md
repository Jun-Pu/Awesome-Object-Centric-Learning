...
**2022** | **NeurIPS** | [Self-Supervised Visual Representation Learning with Semantic Grouping](https://arxiv.org/pdf/2205.15288.pdf) <br><sub> **SlotCon:** Proposing contrastive learning from data-driven semantic slots, for joint semantic grouping and representation learning. </sub> | [Code](https://github.com/CVMI-Lab/SlotCon) | [OpenReview](https://openreview.net/forum?id=H3JObxjd8S) | 
